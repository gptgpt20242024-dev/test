...
$setting = [HelperIdentifier::INFO_LEAD, HelperIdentifier::INFO_USERS];
...
<?php if ($value->address_link): ?>
    ...
    <?= $value->address_link->getFullName(Locations::TYPE_COUNTRY, true, true, true) ?>

    <?php if ($task): ?>
        <div style="margin-top: 10px; display: flex; gap: 10px; flex-wrap: wrap; clear: both;">

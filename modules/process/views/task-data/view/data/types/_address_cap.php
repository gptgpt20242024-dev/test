...
<?php if ($value->cap): ?>
    ...
    <?php if ($value->cap->address && $task): ?>
        <div style="margin-top: 10px; display: flex; gap: 10px; flex-wrap: wrap">
            <?= $this->render('dop_info', ['task' => $task, 'value' => $value]) ?>

            <a href="<?= Url::toRoute(['/order/task/find', 'link_id' => $value->cap->addr_id, 'link_type' => FormTaskSearch::LINK_TYPE_ADDRESS]) ?>" target="_blank" class="btn btn-light btn-sm">Найти наряды</a>

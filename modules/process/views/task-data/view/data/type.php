...
if ($value->type == Req3Identifiers::TYPE_COMMUNICATION_CHANNELS) $xml = "_communication_channel";
...
if ($value->type == Req3Identifiers::TYPE_CHECK_IDENTIFIER) $xml = "_check_identifier";
if ($value->type == Req3Identifiers::TYPE_CRASH) $xml = "_crash";
...
if ($value->type == Req3Identifiers::TYPE_PROJECT_TREE) $xml = "_project_tree";
if ($value->type == Req3Identifiers::TYPE_GHOST) $xml = "_ghost";
if ($value->type == Req3Identifiers::TYPE_QUEUE_LABEL) $xml = "_queue_label";
if ($value->type == Req3Identifiers::TYPE_BONUS_REWARD) $xml = "_bonus_reward.php";
